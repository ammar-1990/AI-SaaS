    ...
    <div>
      <div className="mb-8 space-y-4">
        <h2 className="text-center text-2xl md:text-4xl font-bold ">
          Mystic is here for help
        </h2>
        <p className="text-center text-muted-foreground font-light text-xm md:text-lg">
          Explore the real power of AI with Mystic - How can I help you
        </p>
      </div>
        ...
        {tools.map((tool) => (
          ...
          >
            <div className="flex items-center gap-x-4">
              ...
              <p className="font-semibold text-sm lg:text-base">{tool.label}</p>
            </div>
